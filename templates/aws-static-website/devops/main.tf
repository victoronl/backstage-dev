  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = [
        ...
        "${aws_s3_bucket.static_website.arn}/*",
        "arn:aws:codestar-connections:us-east-1:992382692349:connection/310dfa7f-9edf-4049-9966-1548bf622914",
      ],
    }],
  })
}
...
resource "aws_codepipeline" "static_website_codepipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ConnectionArn    = "arn:aws:codestar-connections:us-east-1:992382692349:connection/310dfa7f-9edf-4049-9966-1548bf622914"
        FullRepositoryId = "victoronl/${var.bucket_name}"
        BranchName       = "main"
      }
    }
  }
